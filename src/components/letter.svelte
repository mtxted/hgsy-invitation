<script lang="ts">
	import letterBottom from '$lib/assets/7.jpg';
	...
	<div class="letter-container">
		<p class="letter {localeStore.locale}">{$_('letter.letter_content')}</p>
			...
			<div class="family-description kr">
				<p>
					변용술<span class="name-divider">{@html nameDivider}</span> 송효진
					<span class="son">의 아들</span>변현규
				</p>
				<p>
					박상국<span class="name-divider">{@html nameDivider}</span> 황예림<span class="daughter"
						>의 딸</span
					>박서윤
				</p>
			</div>
